...
const Contact = () => {
    return (
        <section className='relative flex h-screen w-full flex-col items-center justify-center overflow-hidden'>
            <span className='pointer-events-none whitespace-pre-wrap bg-gradient-to-b from-white from-25% to-black to-[130%] bg-clip-text text-center text-4xl md:text-6xl font-black leading-none text-transparent lg:text-7xl font-cinzel'>
                Contact
            </span>
